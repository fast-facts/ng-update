    ...
    try {
      result = cp.execSync(`node ${ip}`, {
        env: {
          ...
          'GITHUB_REPOSITORY': 'fast-facts/ng-update', // required by github.context
          'GITHUB_WORKSPACE': `${repoDir}`,
          'INPUT_BASE-BRANCH': 'master',
          'INPUT_PR-TITLE': 'chore(ng-update): update angular dependencies',
          'INPUT_PR-BODY': '[ng-update](https://github.com/fast-facts/ng-update) 🤖 has automatically run `ng update` for you and baked this hot 🔥 PR , ready to merge.',
